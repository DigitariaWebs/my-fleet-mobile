            ...
            <View style={styles.filtersRow}>
              <TouchableOpacity style={styles.filterChip} activeOpacity={0.85}>
                <MapPin
                  ...
                  strokeWidth={1.5}
                />
                <Text style={styles.filterChipText}>Nice, France</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.filterChip} activeOpacity={0.85}>
                <Calendar
                  size={16}
                  ...
                  strokeWidth={1.5}
                />
                <Text style={styles.filterChipText}>12 — 15 Juin</Text>
              </TouchableOpacity>
            </View>
          </View>
            ...
            >
              {agencies.slice(0, 3).map((agency, index) => (
                ...
                >
                  {/* Cover Image */}
                  <Image
                    source={{ uri: vehicleImages[index] }}
                    style={styles.agencyCover}
                  />
                  {/* Info */}
                      ...
                      <View style={styles.vehicleBottom}>
                        ...
                        <View style={styles.agencyBadge}>
                          <View style={styles.agencyBadgeDot}>
                            <Text style={styles.agencyBadgeLetter}>
                              {agency?.logo}
                            </Text>
                          </View>
